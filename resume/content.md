...
<div class="resume-skill-category">
  <strong>Libraries & Frameworks:</strong> Express.js, Django, React, Electron.js, GraphQL
</div>
...
- <a href="https://github.com/niuee/hrphysics-simulation" target="_blank"><strong>HR Physics Simulation</strong></a>: A simplified physics simulation implemented in Python.
- <a href="https://github.com/niuee/hrGraphql" target="_blank"><strong>HR GraphQL Server</strong></a>: A GraphQL server implemented in Golang using gqlgen library. This GraphQL server serves as an API endpoint for querying complex data regarding race horses (e.g., the pedigree of a race horse). <a href="https://vntchang.dev/hrgraphql" target="_blank">Live Demo</a>
